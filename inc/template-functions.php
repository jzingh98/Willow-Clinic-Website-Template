...
function gtl_multipurpose_oembed_result( $html, $url, $args = NULL ) {
   if( isset( $args['banner'] ) == 1 ){
     ...
     // return str_replace("?feature=oembed", "?feature=oembed&autoplay=1&controls=0&disablekb=1&fs=0&iv_load_policy=3&loop=1&modestbranding=1&playsinline=1&rel=0&showinfo=0&mute=1", $html);
    ...
    return str_replace("?feature=oembed", "?feature=oembed&autoplay=1&controls=0&loop=1&rel=0&showinfo=0&mute=1", $html);
      ...
      $html =  preg_replace('/height="\d+"/i', 'height="'.$args['height'].'" style="width:'.$args['width'].';height:'.$args['height'].';" ' , $html );
      return $html;
