...
//___Colors___//
    ...
    $wp_customize->add_section(
        ...
        array(
            'title'         => __('Theme Color', 'gtl-multipurpose'),
            'priority'      => 12,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'theme_primary_color',
            array(
                'label' => __('Theme Primary Color', 'gtl-multipurpose'),
                'section' => 'theme_colors_setting',
                'priority' => 12
            )
        )
    );     
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'theme_secondary_color',
            array(
                'label' => __('Theme Secondary Color', 'gtl-multipurpose'),
                'section' => 'theme_colors_setting',
                'priority' => 12
            )
        )
