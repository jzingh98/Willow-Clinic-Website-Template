...
if( ! class_exists( 'GTL_Multipurpose_video' ) ):
...
class GTL_Multipurpose_video extends WP_Widget
{
...
if( ! function_exists( 'gtl_multipurpose_widget_video' ) ):

	/**
     * Register and load widget.
     */
	function gtl_multipurpose_widget_video() {

		register_widget( 'GTL_Multipurpose_video' );

	}

endif;
add_action( 'widgets_init', 'gtl_multipurpose_widget_video' );