...
<?php get_template_part( 'template-parts/banner' );?>
    ...
    <section id="postList" class="jr-site-blog-list all-article-wrap post-<?php echo gtl_multipurpose_blog_layout()?>-view pd-t-100 pd-b-100 <?php if( ! $sidebar ){ echo 'no-sidebar';} ?>">
