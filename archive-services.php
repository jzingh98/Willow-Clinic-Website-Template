...
<?php get_template_part( 'template-parts/banner' );?>
    ...
    <section id="postList" class="jr-site-service-list  pd-t-100 pd-b-100 <?php echo $sidebar?'has-sidebar':'no-sidebar';?>">
    	<div class="<?php echo gtl_multipurpose_site_container();?> content-all">
    		...
    		<div class="<?php echo $row;?>">  
              ...
              <?php if( $sidebar == 'left' ):  get_sidebar();  endif; ?>        
                ...
                <div class="item-wrap compo-service-body layout-s1">
